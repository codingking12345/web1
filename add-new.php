...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `crud`(`sno`, `first_name`, `last_name`, `email`, `gender`) VALUES ('$sno', '$first_name','$last_name','$email','$gender')";
...
<body>
   ...
   <div class="container">
      <div class="text-center mb-4">
         <h2 class="text-muted">Complete the form below to add a new user</h2>
      </div>
